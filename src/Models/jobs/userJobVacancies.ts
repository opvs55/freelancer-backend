import { UserJobVacanciesDB, UserJobVacanciesModel } from "../../Interfaces/users/users.type";




export class UserJobVacancies{
    ...
    public jobVacanciesDB():UserJobVacanciesDB{
        return{
            id: this.id,
            user_id:this.userId,
    ...
    public toJobVacanciesModel():UserJobVacanciesModel{
        return{
            id: this.id,
            userId: this.userId,
