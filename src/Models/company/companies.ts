import { CompaniesDB, CompaniesModel, USER_ROLES } from "../../Interfaces/companies/companies.types";
...
export class Companies{
    ...
    public companiesToDBModel():CompaniesDB{
        return{
            id: this.id,
            name: this.name,
            email: this.email,
    ...
    public toCompaniesModel():CompaniesModel{
        return{
            id: this.id,
            name: this.name,
            email: this.email,
